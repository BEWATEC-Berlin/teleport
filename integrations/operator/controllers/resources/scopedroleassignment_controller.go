...
func (s *scopedRoleAssignmentClient) Update(_ context.Context, _ *accessv1.ScopedRoleAssignment) error {
	return trace.NotImplemented("update is not supported for scoped role assignments")
}
