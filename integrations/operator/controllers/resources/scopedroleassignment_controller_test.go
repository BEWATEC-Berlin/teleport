...
func (g *scopedRoleAssignmentTestingPrimitives) CompareTeleportAndKubernetesResource(
	...
	diff := cmp.Diff(
		...
		testlib.ProtoCompareOptions(
			protocmp.IgnoreFields(&accessv1.ScopedRoleAssignment{}, "status"),
		)...,
	)
	return diff == "", diff
}
...
func TestScopedRoleAssignmentCreation(t *testing.T) {
	...
	testlib.ResourceCreationSynchronousTest(t, resources.NewScopedRoleAssignmentV1Reconciler, test)
}

func TestScopedRoleAssignmentDeletionDrift(t *testing.T) {
	test := &scopedRoleAssignmentTestingPrimitives{}
	testlib.ResourceDeletionDriftSynchronousTest(t, resources.NewScopedRoleAssignmentV1Reconciler, test)
}

func TestScopedRoleAssignmentUpdate(t *testing.T) {
	test := &scopedRoleAssignmentTestingPrimitives{}
	testlib.ResourceUpdateTestSynchronous(t, resources.NewScopedRoleAssignmentV1Reconciler, test)
}
