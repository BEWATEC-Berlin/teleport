...
import (
	...
	v123 "github.com/gravitational/teleport/api/gen/proto/go/teleport/beams/v1"
...
func (x *Event) GetBeam() *v123.Beam {
	if x != nil {
...
type Event_Beam struct {
	...
	Beam *v123.Beam `protobuf:"bytes,89,opt,name=Beam,proto3,oneof"`
}
...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"\x04Beam\x18Y \x01(\v2\x17.teleport.beams.v1.BeamH\x00R\x04BeamB\n" +
	"\n" +
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*v123.Beam)(nil),                           // 82: teleport.beams.v1.Beam
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	82, // 84: proto.Event.Beam:type_name -> teleport.beams.v1.Beam
